...
namespace WellnessCenter.Controllers
{
    public class ServicesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Price,Description")] ServiceDto service)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Price,Description")] Service service)
        {
            if (id != service.Id)
            {
                return NotFound();
